...
|---|---:|---:|---:|---:|
| am_peak | 07:00-09:00 | 5090 | 110 / 110 | False |
| offpeak | 14:30-16:30 | 3636 | 90 / 90 | True |
| pm_peak | 17:30-19:30 | 5454 | 120 / 120 | False |

## 运行

```powershell
$env:SUMO_HOME='C:/path/to/sumo'
& $env:SUMO_HOME/bin/sumo-gui.exe -c demo_8_am_peak.sumocfg
& $env:SUMO_HOME/bin/sumo.exe -c demo_8_pm_peak.sumocfg
```

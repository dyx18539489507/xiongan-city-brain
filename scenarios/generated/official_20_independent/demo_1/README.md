...
|---|---:|---:|---:|---:|
| am_peak | 07:00-09:00 | 3998 | 160 / 160 | True |
| offpeak | 14:30-16:30 | 2525 | 140 / 140 | True |
| pm_peak | 17:30-19:30 | 4592 | 160 / 160 | False |

## 运行

```powershell
$env:SUMO_HOME='C:/path/to/sumo'
& $env:SUMO_HOME/bin/sumo-gui.exe -c demo_1_am_peak.sumocfg
& $env:SUMO_HOME/bin/sumo.exe -c demo_1_pm_peak.sumocfg
```

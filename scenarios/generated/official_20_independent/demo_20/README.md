...
|---|---:|---:|---:|---:|
| am_peak | 07:00-09:00 | 2633 | 120 / 120 | False |
| offpeak | 14:30-16:30 | 1041 | 90 / 90 | True |
| pm_peak | 17:30-19:30 | 2361 | 110 / 110 | False |

## 运行

```powershell
$env:SUMO_HOME='C:/path/to/sumo'
& $env:SUMO_HOME/bin/sumo-gui.exe -c demo_20_am_peak.sumocfg
& $env:SUMO_HOME/bin/sumo.exe -c demo_20_pm_peak.sumocfg
```

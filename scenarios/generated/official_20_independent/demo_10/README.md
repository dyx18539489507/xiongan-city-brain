...
|---|---:|---:|---:|---:|
| am_peak | 07:00-09:00 | 3609 | 120 / 120 | False |
| offpeak | 14:30-16:30 | 1884 | 90 / 90 | False |
| pm_peak | 17:30-19:30 | 3711 | 120 / 120 | False |

## 运行

```powershell
$env:SUMO_HOME='C:/path/to/sumo'
& $env:SUMO_HOME/bin/sumo-gui.exe -c demo_10_am_peak.sumocfg
& $env:SUMO_HOME/bin/sumo.exe -c demo_10_pm_peak.sumocfg
```

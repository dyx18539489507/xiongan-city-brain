...
|---|---:|---:|---:|---:|
| am_peak | 07:00-09:00 | 3140 | 145 / 145 | True |
| offpeak | 14:30-16:30 | 1260 | 145 / 145 | True |
| pm_peak | 17:30-19:30 | 2822 | 145 / 145 | True |

## 运行

```powershell
$env:SUMO_HOME='C:/path/to/sumo'
& $env:SUMO_HOME/bin/sumo-gui.exe -c demo_9_am_peak.sumocfg
& $env:SUMO_HOME/bin/sumo.exe -c demo_9_pm_peak.sumocfg
```

...
|---|---:|---:|---:|---:|
| am_peak | 07:00-09:00 | 4953 | 80 / 80 | True |
| offpeak | 14:30-16:30 | 5474 | 80 / 80 | False |
| pm_peak | 17:30-19:30 | 6598 | 80 / 80 | False |

## 运行

```powershell
$env:SUMO_HOME='C:/path/to/sumo'
& $env:SUMO_HOME/bin/sumo-gui.exe -c demo_18_am_peak.sumocfg
& $env:SUMO_HOME/bin/sumo.exe -c demo_18_pm_peak.sumocfg
```

...
|---|---:|---:|---:|---:|
| am_peak | 07:00-09:00 | 3413 | 180 / 180 | False |
| offpeak | 14:30-16:30 | 1999 | 140 / 140 | True |
| pm_peak | 17:30-19:30 | 4073 | 180 / 180 | False |

## 运行

```powershell
$env:SUMO_HOME='C:/path/to/sumo'
& $env:SUMO_HOME/bin/sumo-gui.exe -c demo_4_am_peak.sumocfg
& $env:SUMO_HOME/bin/sumo.exe -c demo_4_pm_peak.sumocfg
```
